...
# The list of the columns I'd encoder
Yes_No_Col = [
...
# Function for trainning and caching the preprocessor
@st.cache_resource
...
if st.button("🔮 Predict Churn"):
    ...
    # Selecting the features that the model expect, When I was deploying the app I really truggled in this part
    cols_23 = [
    ...
    # Making prediction and getting churn proba
